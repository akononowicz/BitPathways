...
public class MoveAllRightCommmand extends MoveAllCommmand {
	
	public static String NAME=messages.getString("ACTION.MOVE.PRAWO");
		
	public MoveAllRightCommmand(PathModel _model,JFrame _parent){
		super(NAME);model=_model;parent=_parent;
		
		dir=super.MOVE_RIGHT;
	}
}
