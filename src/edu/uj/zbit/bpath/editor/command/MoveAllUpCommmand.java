...
public class MoveAllUpCommmand extends MoveAllCommmand {
	
	public static String NAME=messages.getString("ACTION.MOVE.UP");
		
	public MoveAllUpCommmand(PathModel _model,JFrame _parent){
