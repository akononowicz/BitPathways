...
public class MoveAllDownCommmand extends MoveAllCommmand {
	
	public static String NAME=messages.getString("ACTION.MOVE.DOWN");
		
	public MoveAllDownCommmand(PathModel _model,JFrame _parent){
